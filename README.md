...
Source-linked topical news coverage from a public RSS feed. This product does not publish a risk or exposure score.

**Live dashboard:** https://sdcofa.github.io/climate-security-index/

## Published methodology

- **Source:** Google News RSS; query: `(climate OR drought OR famine OR agriculture)`. Google News chooses the matching sources; this is a convenience sample, not a complete census.
...
- **Limit:** News coverage is not a climate-security risk score, drought measurement, food-security estimate, or conflict forecast. Search ranking, publisher coverage, duplication and publication delays bias the sample. Follow linked primary sources before drawing conclusions.
